...
export const metadata: Metadata = {
  title: "Southern Underground LA | Blog",
  description: "Blog & Recent news in Contruction Industry LA",
  // other metadata
};
...
const Blog = () => {
  return (
    <>
      <Breadcrumb
        pageName="Blog Grid"
        description="Stay informed with industry insights, safety tips, and project highlights from Southern Underground."
      />
